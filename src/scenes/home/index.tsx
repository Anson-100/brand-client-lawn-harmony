          ...
          <div className="my-auto mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
            ...
            <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
              <p className="text-lg text-zinc-700 sm:text-xl/8">
                ...
                Whether it’s turf, palms, or shrubs, we’ve got you covered.
              </p>
              {/* BUTTONS================ */}
              <div className="mt-10 flex items-center gap-4">
                ...
                <button
                  ...
                  className=" group hover:cursor-pointer transition-all duration-100 font-semibold text-gray-900  px-5 py-3 flex items-center"
                >
                  Your Account
                  <span
